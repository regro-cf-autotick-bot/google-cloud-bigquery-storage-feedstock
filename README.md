...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-bigquery-storage-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-bigquery-storage-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-bigquery-storage google-cloud-bigquery-storage-core
# for installing globally
pixi global install google-cloud-bigquery-storage google-cloud-bigquery-storage-core
```
...
It is possible to list all of the versions of `google-cloud-bigquery-storage` available on your platform:
...
```
pixi search google-cloud-bigquery-storage --channel conda-forge
```
